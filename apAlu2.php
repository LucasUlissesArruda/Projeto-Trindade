  ...
  <div class="container" style="height: 100%;">
    <div class="row">
      <div class="col-md-6" style="padding-top: 10px; padding-bottom: 35px; ">
                <br>
                <h1 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 45px;">Edifício Dijon - Parque Campolim</h1><h2 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;  font-size: 18px;" >Centro de Maringa, 400m² - VilaMarumby - Maringá/PR</h2>
            </div>
            <div class="col-md-6">
              <h2 style="color: #fff; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; padding-left: 300px; padding-top: 25px;"><br> <div style="border: #ffffff 2px solid; background-color: #89745a; border-radius: 30px; padding-left: 15px;">R$ 10.000,00 / mês</div> </h2>
            </div>
        </div>
        <hr>
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/apAlu2.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/apAlu22.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/apAlu222.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="container" >
        ...
        <div class="cama" >
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">314 m²</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">05 Quartos</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">04 Suites</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">05 Banheiros</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">03 Vagas</h1>
        </div>
        <br>
        <hr>
        <br>
        <h5 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            Apartamentos de 314 m² e 366 m² com 4 suítes. Localizado no Alto do Campolim. Lazer completo com quadra esportiva, piscina aquecida, quadra de squash, fitness, pet garden, coworking e muito mais.        </h5>
        <br>
