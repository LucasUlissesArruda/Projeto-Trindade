  ...
  <div class="container" style="height: 100%;">
    <div class="row">
      <div class="col-md-6" style="padding-top: 10px; padding-bottom: 35px; ">
                <br>
                <h1 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 45px;">Casa em Trancoso</h1><h2 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;  font-size: 18px;" >Centro de Maringa, 400m² - VilaMarumby - Maringá/PR</h2>
            </div>
            <div class="col-md-6">
              <h2 style="color: #fff; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; padding-left: 300px; padding-top: 25px;"><br> <div style="border: #ffffff 2px solid; background-color: #89745a; border-radius: 30px; padding-left: 15px;">R$ 8.000,00 (A Diaria)</div> </h2>
            </div>
        </div>
        <hr>
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/casaAlu1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/casaAlu11.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/casaAlu111.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="container" >
        ...
        <div class="cama" >
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">750m²</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">08 Quartos</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">06 Suites</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">08 Banheiros</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">06 Vagas</h1>
        </div>
        <br>
        <hr>
        <br>
        <h5 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            Localizada no Condomínio Terravista Golf, a Casa Violeta conta 750m e traz como diferencial o conceito casa hotel. O seu espaço composto por piscina, área gourmet, academia, sauna, sala de tv, e 08 quartos ao todo é o convite perfeito para dias relaxantes no vilarejo mais desejado do país. Sinta-se a vontade para desbravar essa sofisticada residência em Trancoso, Bahia.
        </h5>
        <br>
        ...
        <br>
        <h3 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            O condomínio conta com playground, espaço gourmet, salão de festas, academia, lounge e espaço
            multiuso.
        </h3>
        <h3 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
