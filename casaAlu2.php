...
<head>
    ...
    <title>CasaAlu2</title>
</head>
<body  class="bg-gradient" style="background-color: #f8f1e8;">
<?php 
  ...
  <div class="container" style="height: 100%;">
    <div class="row">
      <div class="col-md-6" style="padding-top: 10px; padding-bottom: 35px; ">
                <br>
                <h1 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 45px;">Casa 40 – Rio da Barra</h1><h2 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;  font-size: 18px;" >Condomínio Fazenda Rio da Barra - Trancoso</h2>
            </div>
            <div class="col-md-6">
              <h2 style="color: #fff; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; padding-left: 300px; padding-top: 25px;"><br> <div style="border: #ffffff 2px solid; background-color: #89745a; border-radius: 30px; padding-left: 15px;">R$ 15.000,00 (A Diaria)</div> </h2>
            </div>
        </div>
        <hr>
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/casaAlu2.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/casaAlu22.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/casaAlu222.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="container" >
        ...
        <br>
        <div class="cama" >
            <svg style="color: #89745a;" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <br>
        <h3 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            A casa conta com espaço de jogos, espaço gourmet, academia, lounge e espaço
            multiuso, saúna, Spa.
        </h3>
        <h3 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            Ficou interessado? Entre em contato conosco e agende sua visita!
        </h3>
    </div>
</div>
