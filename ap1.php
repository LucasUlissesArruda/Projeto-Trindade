...
<body  class="bg-gradient" style="background-color: #f8f1e8;">
  ...
  <div class="container" style="height: 100%;">
    <div class="row">
      <div class="col-md-7" style="padding-top: 10px; padding-bottom: 35px; ">
                <br>
                <h1 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 45px;">Apartamento na Zona 1</h1><h2 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;  font-size: 18px;" >Centro de Maringa, 200m² - Zona 1 - Maringá/PR</h2>
            </div>
            <div class="col-md-5">
              <h2 style="color: #fff; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; padding-left: 300px; padding-top: 25px;"><br> <div style="border: #ffffff 2px solid; background-color: #89745a; border-radius: 30px; padding-left: 15px;">R$ 500.000,00</div> </h2>
            </div>
        </div>
        <hr>
    <div id="carouselExampleFade" class="carousel slide carousel-fade">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/ap3.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/ap2-cortada.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="img/ap1.png" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="container" >
        ...
        <div class="cama" >
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">200m²</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">04 Quartos</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">01 Suites</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">03 Banheiros</h1>
            ...
            <h1 style="font-size: 20px; letter-spacing: .4rem; color: #89745a">02 Vagas</h1>
        </div>
        <br>
        <hr>
        <br>
        <h5 style="color: #89745a; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
            A procura de um apatamento em uma localização excelente? Principalmente para quem está em busca de um
            imóvel no centro, uma oportunidade imperdível!
        </h5>
        <br>
